...
<head>
	...
	<title>Process Orders | Inventory</title>
    <!-- CSS only -->
...
<body>
  <nav class="your-cart">
      <div class="cart-header">
          <a href="inventory-orders-new.php"><i class="fa-solid fa-arrow-left alt back-arrow"></i></a>
          <h4 class="cart-h4">Process Order</h4>
      </div>
    </nav>
  ...
  <div class="container-fluid">
    <div class="order-completed">
        <div class="order-text">
            <h5>Click Order Fulfilled</h5>
            <p>if order has been delivered.</p>
        </div>
    ...
    <div class="container">
        ...
        $select_orders = "SELECT * FROM `user_orders` o, `users` u WHERE o.user_id = u.usersId AND o.order_id = $order_id";
        ...
        if(isset($_POST['shipping-fee'])){
            $post_shipping = mysqli_real_escape_string($link, $_POST['shipping-fee']);
            $update_order_shipping = "UPDATE `user_orders` SET shipping_fee=$post_shipping WHERE order_id=$order_id AND user_id=$user_id";
            $run_update_order = mysqli_query($link, $update_order_shipping);
            if ($run_update_order){
                echo "<script>alert('Shipping Fee Updated!');</script>";
            }else {
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="mb-3 d-flex justify-content-between">
                    <div>
                    <span class="me-3"><?php echo $order_type ?> Order #<?php echo $order_id?></span><span class="badge rounded-pill bg-info"><?php if($order_status="Pending" || $order_status="Shipping"){echo "Pending";}else{echo "Delivered";}?></span><br>
                ...
                <table class="table table-borderless">
                    ...
                    <?php 
                    // Select Order Items
                    $select_order_prods = "SELECT o.order_id, o.invoice_number, o.total_products, o.order_date, o.shipping_fee, o.amount_due, oi.product_id, oi.product_title, oi.product_img, oi.quantity, oi.selected_price FROM `user_orders` o, `user_orders_products` oi WHERE o.order_id=$order_id AND oi.order_id=$order_id";
                    ...
                    <tr>
                        ...
                        <td class="text-end">P<input type="number" value="<?php echo $shipping_fee?>" placeholder="Enter shipping fee..." name='shipping-fee' required>.00 <button class="btn-fulfilled" type='submit'>Update</button></td>                    
                    </tr>
                    <tr class="fw-bold">
      ...
      <a href="php/process-order.php?order_id=<?php echo $order_id?>" onclick="return confirm('Click OK to confirm that this order has been delivered.')"><button class="btn-fulfilled">Order Fulfilled!</button></a>
        <button class="btn-delete"><a href="#" onclick="return confirm('Are you sure you want to DELETE this order?')">Cancel Order</a></button>
    </div>
    </div>
</body>
