...
<body>
    ...
    if(isset($_POST['insert-categ'])){
        ...
        //Insert Query
        $insert_category = "INSERT into aquarium_categories (category_title, category_img) values ('$category_title', '$category_image')";
        ...
        <div class="add-details-container">
            <div class="add_container">
                <div class="add_topNav">
                    <h1>Insert Category | Aquarium</h1>
