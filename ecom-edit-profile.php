                ...
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                    <div>
                      ...
                      <span class="description">To ship</span>
                    </div>
                    <div>
                      <span class="heading">10</span>
                      <span class="description">To pay</span>
                    </div>
                    <div>
            ...
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="#!" class="btn btn-sm btn-primary">Delete Account</a>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value="09776">
                      </div>
                    </div>
                  </div>
                </div>
